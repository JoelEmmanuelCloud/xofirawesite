...
export function PhoneDemo({ className }: { className?: string }) {
  ...
  return (
    <div className={cn("relative [perspective:1600px]", className)}>
      ...
      <div className="[transform:rotateY(-14deg)_rotateX(6deg)] [transform-style:preserve-3d]">
        <div className="animate-float-slow">
          <div className="relative mx-auto w-[300px] rounded-[2.8rem] border border-white/15 bg-gradient-to-b from-slate-800 to-slate-950 p-2.5 shadow-[0_50px_90px_-30px_rgba(0,0,0,0.65)] ring-1 ring-black/40">
...
function SuccessScreen() {
  return (
    <div className="flex h-full flex-col items-center justify-center pb-10 text-center">
      ...
      <p className="mt-1 tabular text-2xl font-bold text-[#1fb35a]">
        CFA 35,646
      </p>
